...
import org.springblade.modules.uni.mapper.RouteMapper;
...
public class RouteServiceImpl extends ServiceImpl<RouteMapper, Route> implements IRouteService {
	...
	@Override
	public IPage<RouteVO> selectRoutePage(IPage<RouteVO> page, RouteVO route) {
		return page.setRecords(baseMapper.selectRoutePage(page, route));
	}
